          ...
          return function (startDay) {
              return function (state) {
                  ...
                  if ($8) {
                      ...
                      var $11 = val === 1;
                      if ($11) {
                          return Data_Show.show(Data_Date_Component.showMonth)(toEnumL(Data_Date_Component.boundedEnumMonth)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(state.monthSelected) - 1 | 0));
                      };
                      return "";
                  };
 ...
 */  
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Next) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      ...
                      return toEnumL(Data_Date_Component.boundedEnumMonth)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(st.monthSelected) + 1 | 0);
                  })();
          ...
          throw new Error("Failed pattern match at Main line 177, column 17 - line 177, column 71: " + [ v.constructor.name ]);
      };
