...
(function(exports) { exports["logMe"]= function(val){ console.log(val); return val;}
})(PS["Main"] = PS["Main"] || {});
(function(exports) {
  /* global exports */
  "use strict";
...
(function(exports) {
  ...
  var wsProducer = function (socket) {
      var readHelper = function (read) {
          return function ($42) {
              return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(read(Data_Foreign.toForeign($42))));
          };
      };
  ...
  var wsConsumer = function (query) {
      return Control_Coroutine.consumer(Control_Monad_Aff.monadAff)(function (msg) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(query(Halogen_Query.action(WebHook.create(msg))))(function () {
  ...
  var startOfMonth = function (state) {
      return Data_Enum.fromEnum(Data_Date_Component.boundedEnumWeekday)(Data_Date.weekday(Data_Date.canonicalDate(toEnumL(Data_Date_Component.boundedEnumYear)(state.yearSelected))(state.monthSelected)(toEnumL(Data_Date_Component.boundedEnumDay)(1))));
  };
  var getPreviousMonth = function (monthSelected) {
      var $11 = Data_Eq.eq(Data_Date_Component.eqMonth)(monthSelected)(Data_Date_Component.January.value);
      if ($11) {
          ...
          return function (startDay) {
              return function (state) {
                  ...
                  if ($12) {
                      var $13 = startDay === val;
                      if ($13) {
                          return Data_Show.show(Data_Date_Component.showMonth)(state.monthSelected) + Data_Show.show(Data_Show.showInt)(1);
                      };
                      var $14 = startDay < val;
                      if ($14) {
                          return Data_Show.show(Data_Show.showInt)((val - startDay | 0) + 1 | 0);
                      };
                      var $15 = val === 1;
                      if ($15) {
                          return Data_Show.show(Data_Date_Component.showMonth)(getPreviousMonth(state.monthSelected));
                      };
                      return "";
                  };
                  var $16 = index === 2 && startDay !== 1;
                  if ($16) {
                      return Data_Show.show(Data_Show.showInt)(8 - (startDay - val | 0) | 0);
                  };
                  var $17 = startDay >= val;
                  if ($17) {
                      var $18 = state.endDate >= ((((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0);
                      if ($18) {
                          return Data_Show.show(Data_Show.showInt)((((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0);
                      };
                      return "";
                  };
                  var $19 = state.endDate >= (((val - startDay | 0) + 1 | 0) + ((index - 1 | 0) * 7 | 0) | 0);
                  if ($19) {
                      return Data_Show.show(Data_Show.showInt)(((val - startDay | 0) + 1 | 0) + ((index - 1 | 0) * 7 | 0) | 0);
                  };
                  return "";
              };
          };
  ...
  var tableView = function (state) {
      var makeRow = function (startDay) {
          return function (index) {
              return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.attr("height")("50") ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(1)(startDay)(state)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(Data_Array.index(state.eventData)(0))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text(getText(index)(1)(startDay)(state)) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(2)(startDay)(state)) ])([ Halogen_HTML_Core.text(getText(index)(2)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(3)(startDay)(state)) ])([ Halogen_HTML_Core.text(getText(index)(3)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(4)(startDay)(state)) ])([ Halogen_HTML_Core.text(getText(index)(4)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(5)(startDay)(state)) ])([ Halogen_HTML_Core.text(getText(index)(5)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(6)(startDay)(state)) ])([ Halogen_HTML_Core.text(getText(index)(6)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + getText(index)(7)(startDay)(state)) ])([ Halogen_HTML_Core.text(getText(index)(7)(startDay)(state)) ]) ]);
          };
      };
      return Halogen_HTML_Elements.table([ Halogen_HTML_Properties.attr("width")("100%") ])([ Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(makeRow(startOfMonth(state)))([ 1, 2, 3, 4, 5, 6 ])) ]);
  };
  var getNextMonth = function (monthSelected) {
      var $20 = Data_Eq.eq(Data_Date_Component.eqMonth)(monthSelected)(Data_Date_Component.December.value);
      if ($20) {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Next) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      var $22 = Data_Eq.eq(Data_Date_Component.eqMonth)(st.monthSelected)(Data_Date_Component.December.value);
                      if ($22) {
                          return Data_Date_Component.January.value;
                      };
                  ...
                  var newYear = (function () {
                      var $23 = Data_Eq.eq(Data_Date_Component.eqMonth)(newMonth)(Data_Date_Component.January.value);
                      if ($23) {
                  ...
                  $24.monthSelected = newMonth;
                  $24.yearSelected = newYear;
                  $24.endDate = lastDay;
                  return $24;
              }))(function () {
          ...
          if (v instanceof Prev) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      var $28 = Data_Eq.eq(Data_Date_Component.eqMonth)(st.monthSelected)(Data_Date_Component.January.value);
                      if ($28) {
                          return Data_Date_Component.December.value;
                      };
                  ...
                  var newYear = (function () {
                      var $29 = Data_Eq.eq(Data_Date_Component.eqMonth)(newMonth)(Data_Date_Component.December.value);
                      if ($29) {
                          return st.yearSelected - 1 | 0;
                      };
                      return st.yearSelected;
                  ...
                  $30.monthSelected = newMonth;
                  $30.yearSelected = newYear;
                  $30.endDate = lastDay;
                  return $30;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          ...
          if (v instanceof WebHook) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $34.eventData = [ $foreign.logMe(v.value0) ];
                  return $34;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at Main line 186, column 17 - line 186, column 71: " + [ v.constructor.name ]);
      };
