...
(function(exports) {// const {Client} = require("pg")
...
(function(exports) {
  ...
  var Prev = (function () {
      function Prev(value0) {
          this.value0 = value0;
      };
      Prev.create = function (value0) {
          return new Prev(value0);
      };
      return Prev;
  })();
  var WebHook = (function () {
      function WebHook(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      WebHook.create = function (value0) {
          return function (value1) {
              return new WebHook(value0, value1);
          };
      };
      return WebHook;
  })();
  ...
  var wsProducerS = function (socke) {
      return Control_Coroutine_Aff.produce(function (emit) {
          return function __do() {
              var v = WebSocket.newWebSocket("ws://localhost:8010")([  ])();
              return Control_Monad_Eff_Var.set(Control_Monad_Eff_Var.settableSettableVar)(v.onmessage)(function (event) {
                  return emit(Data_Either.Left.create(WebSocket.runMessage(WebSocket.runMessageEvent(event))));
              })();
          };
      });
  };
  var wsProducer = function (socket) {
      var readHelper = function (read) {
          return function ($55) {
              return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(read(Data_Foreign.toForeign($55))));
          };
      };
  ...
  var toEnumL = function (dictBoundedEnum) {
      return function (a) {
          return Data_Maybe.fromJust()(Data_Enum.toEnum(dictBoundedEnum)(a));
      };
  };
  var tableViewDays = function (state) {
      return Halogen_HTML_Elements.table([ Halogen_HTML_Properties.attr("width")("100%") ])([ Halogen_HTML_Elements.tbody_([ Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("MON") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("TUE") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("WED") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("THUR") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("FRI") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("SAT") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text("SUN") ]) ]) ]) ]);
  };
  var startOfMonth = function (year) {
      return function (month) {
          return Data_Enum.fromEnum(Data_Date_Component.boundedEnumWeekday)(Data_Date.weekday(Data_Date.canonicalDate(toEnumL(Data_Date_Component.boundedEnumYear)(year))(month)(toEnumL(Data_Date_Component.boundedEnumDay)(1))));
      };
  };
  var getPreviousMonth = function (monthSelected) {
      var $13 = Data_Eq.eq(Data_Date_Component.eqMonth)(monthSelected)(Data_Date_Component.January.value);
      if ($13) {
          return Data_Date_Component.December.value;
      };
      return toEnumL(Data_Date_Component.boundedEnumMonth)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(monthSelected) - 1 | 0);
  };
  var getText = function (index) {
      return function (val) {
          return function (startDay) {
              return function (state) {
                  ...
                  if ($14) {
                      ...
                      if ($15) {
                          return {
                              value: Data_Show.show(Data_Date_Component.showMonth)(state.monthSelected) + Data_Show.show(Data_Show.showInt)(1),
                              index: 1
                          };
                      };
                      var $16 = startDay < val;
                      if ($16) {
                          return {
                              value: Data_Show.show(Data_Show.showInt)((val - startDay | 0) + 1 | 0),
                              index: (val - startDay | 0) + 1 | 0
                          };
                      };
                      var $17 = val === 1;
                      if ($17) {
                          return {
                              value: Data_Show.show(Data_Date_Component.showMonth)(getPreviousMonth(state.monthSelected)),
                              index: val
                          };
                      };
                      return {
                  ...
                  var $18 = index === 2 && startDay !== 1;
                  if ($18) {
                      return {
                          value: Data_Show.show(Data_Show.showInt)(8 - (startDay - val | 0) | 0),
                          index: (8 - startDay | 0) + val | 0
                      };
                  };
                  var $19 = startDay >= val;
                  if ($19) {
                      var $20 = state.endDate >= ((((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0);
                      if ($20) {
                          return {
                              value: Data_Show.show(Data_Show.showInt)((((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0),
                              index: (((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0
                          };
                      };
                      return {
                          value: "",
                  ...
                  var $21 = state.endDate >= (((val - startDay | 0) + 1 | 0) + ((index - 1 | 0) * 7 | 0) | 0);
                  if ($21) {
                      return {
                          value: Data_Show.show(Data_Show.showInt)(((val - startDay | 0) + 1 | 0) + ((index - 1 | 0) * 7 | 0) | 0),
                          index: ((val - startDay | 0) + 1 | 0) + ((index - 1 | 0) * 7 | 0) | 0
                      };
                  };
                  return {
                      value: "",
  ...
  var tableView = function (state) {
      var makeRow = function (startDay) {
          return function (index) {
              return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.attr("height")("50") ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(1)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $22 = index === 1;
                  if ($22) {
                      return Data_Array.index(state.eventData)(0);
                  };
                  return Data_Array.index(state.eventData)(1 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(1)(startDay)(state)).value) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(2)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $23 = index === 2;
                  if ($23) {
                      return Data_Array.index(state.eventData)(1);
                  };
                  return Data_Array.index(state.eventData)(2 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(2)(startDay)(state)).value) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(3)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $24 = index === 3;
                  if ($24) {
                      return Data_Array.index(state.eventData)(2);
                  };
                  return Data_Array.index(state.eventData)(3 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(3)(startDay)(state)).value) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(4)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $25 = index === 4;
                  if ($25) {
                      return Data_Array.index(state.eventData)(3);
                  };
                  return Data_Array.index(state.eventData)(4 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(4)(startDay)(state)).value) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(5)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $26 = index === 5;
                  if ($26) {
                      return Data_Array.index(state.eventData)(4);
                  };
                  return Data_Array.index(state.eventData)(5 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(5)(startDay)(state)).value) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(6)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $27 = index === 6;
                  if ($27) {
                      return Data_Array.index(state.eventData)(5);
                  };
                  return Data_Array.index(state.eventData)(6 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(6)(startDay)(state)).value) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%"), Halogen_HTML_Properties.attr("align")("right"), Halogen_HTML_Properties.ref("DayStage" + (getText(index)(7)(startDay)(state)).value) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Left_Text") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")((function () {
                  var $28 = index === 7;
                  if ($28) {
                      return Data_Array.index(state.eventData)(6);
                  };
                  return Data_Array.index(state.eventData)(7 + (7 * index | 0) | 0);
              })())) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("Right_Text") ])([ Halogen_HTML_Core.text((getText(index)(7)(startDay)(state)).value) ]) ]) ]);
          };
      };
      return Halogen_HTML_Elements.table([ Halogen_HTML_Properties.attr("width")("100%") ])([ Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(makeRow(startOfMonth(state.yearSelected)(state.monthSelected)))([ 1, 2, 3, 4, 5, 6 ])) ]);
  };
  var getNow = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Now.nowDate))(function (v) {
      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v.value1);
  });
  var wsConsumer = function (query) {
      return Control_Coroutine.consumer(Control_Monad_Aff.monadAff)(function (msg) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(getNow)(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(query(Halogen_Query.action(WebHook.create(Data_Array.singleton(msg)))))(function () {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
              });
          });
      });
  };
  var getNextMonth = function (monthSelected) {
      var $33 = Data_Eq.eq(Data_Date_Component.eqMonth)(monthSelected)(Data_Date_Component.December.value);
      if ($33) {
          return Data_Date_Component.January.value;
      };
      return toEnumL(Data_Date_Component.boundedEnumMonth)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(monthSelected) + 1 | 0);
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("Github Calendar") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("UnderLine") ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Date_Component.showMonth)(state.monthSelected) + Data_Show.show(Data_Show.showInt)(state.yearSelected)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Next.create)), Halogen_HTML_Properties.class_("next_button") ])([ Halogen_HTML_Core.text("NEXT>>") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Prev.create)), Halogen_HTML_Properties.class_("prev_button") ])([ Halogen_HTML_Core.text("<<PREV") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([  ])([ tableViewDays(state), tableView(state) ]) ]) ]);
      };
      var initialStateData = {
          monthSelected: Data_Date_Component.January.value,
          yearSelected: 2018,
          endDate: 31,
          eventData: $foreign.getEventData(2018)(startOfMonth(2018)(toEnumL(Data_Date_Component.boundedEnumMonth)(1)))(1)
      };
      var $$eval = function (v) {
          if (v instanceof Next) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      var $35 = Data_Eq.eq(Data_Date_Component.eqMonth)(st.monthSelected)(Data_Date_Component.December.value);
                      if ($35) {
                          return Data_Date_Component.January.value;
                      };
                      return getNextMonth(st.monthSelected);
                  })();
                  var newYear = (function () {
                      var $36 = Data_Eq.eq(Data_Date_Component.eqMonth)(newMonth)(Data_Date_Component.January.value);
                      if ($36) {
                          return st.yearSelected + 1 | 0;
                      };
                      return st.yearSelected;
                  })();
                  var lastDay = Data_Enum.fromEnum(Data_Date_Component.boundedEnumDay)(Data_Date.lastDayOfMonth(toEnumL(Data_Date_Component.boundedEnumYear)(newYear))(newMonth));
                  var eventData = $foreign.getEventData(newYear)(startOfMonth(newYear)(newMonth))(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(newMonth));
                  var $37 = {};
                  for (var $38 in st) {
                  ...
                  $37.monthSelected = newMonth;
                  $37.yearSelected = newYear;
                  $37.endDate = lastDay;
          ...
          if (v instanceof Prev) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      var $41 = Data_Eq.eq(Data_Date_Component.eqMonth)(st.monthSelected)(Data_Date_Component.January.value);
                      if ($41) {
                          return Data_Date_Component.December.value;
                      };
                      return getPreviousMonth(st.monthSelected);
                  })();
                  var newYear = (function () {
                      var $42 = Data_Eq.eq(Data_Date_Component.eqMonth)(newMonth)(Data_Date_Component.December.value);
                      if ($42) {
                          return st.yearSelected - 1 | 0;
                      };
                      return st.yearSelected;
                  ...
                  $43.monthSelected = newMonth;
                  $43.yearSelected = newYear;
                  $43.endDate = lastDay;
          ...
          if (v instanceof WebHook) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $47.eventData = v.value0;
                  return $47;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at Main line 200, column 17 - line 200, column 71: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](initialStateData),
          render: render,
          "eval": $$eval,
  ...
  var main = function __do() {
      var v = DOM_Websocket_WebSocket.create("ws://demos.kaazing.com/echo")([  ])();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)(v1))(function (v2) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Coroutine.runProcess(Control_Monad_Aff.monadRecAff)(Control_Coroutine.connect(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelAff)(wsProducerS(v))(wsConsumer(v2.query))))(function () {
  ...
  exports["wsProducerS"] = wsProducerS;
  exports["Next"] = Next;
  exports["Prev"] = Prev;
  exports["WebHook"] = WebHook;
  exports["toEnumL"] = toEnumL;
  ...
  exports["tableViewDays"] = tableViewDays;
  exports["component"] = component;
  exports["logMe"] = $foreign.logMe;
  exports["jsonParse"] = $foreign.jsonParse;
  exports["pushEvent"] = $foreign.pushEvent;
  exports["getAllEvents"] = $foreign.getAllEvents;
  exports["getEventData"] = $foreign.getEventData;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();