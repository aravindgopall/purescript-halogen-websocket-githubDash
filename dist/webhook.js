...
(function(exports) {
  ...
  var wsProducer = function (socket) {
      var readHelper = function (read) {
          return function ($28) {
              return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(read(Data_Foreign.toForeign($28))));
          };
      };
      ...
      return function (val) {
          return function (startDay) {
              return function (state) {
                  ...
                  var $12 = index === 2 && startDay !== 1;
                  if ($12) {
                      return Data_Show.show(Data_Show.showInt)(8 - (startDay - val | 0) | 0);
                  };
                  var $13 = startDay >= val;
                  if ($13) {
                      var $14 = state.endDate >= ((((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0);
                      if ($14) {
                          return Data_Show.show(Data_Show.showInt)((((index - 1 | 0) * 8 | 0) - (index - 2 | 0) | 0) - (startDay - val | 0) | 0);
                      };
                      return "";
                  };
                  var $15 = state.endDate >= (((val - startDay | 0) + 1 | 0) + ((index - 1 | 0) * 7 | 0) | 0);
                  if ($15) {
  ...
  var tableView = function (state) {
      var makeRow = function (startDay) {
          return function (index) {
              return Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(1)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(2)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(3)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(4)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(5)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(6)(startDay)(state)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("width")("15%") ])([ Halogen_HTML_Core.text(getText(index)(7)(startDay)(state)) ]) ]);
          };
      };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Next) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      var $17 = Data_Eq.eq(Data_Date_Component.eqMonth)(st.monthSelected)(Data_Date_Component.December.value);
                      if ($17) {
                  ...
                  var newYear = (function () {
                      var $18 = Data_Eq.eq(Data_Date_Component.eqMonth)(newMonth)(Data_Date_Component.January.value);
                      if ($18) {
          ...
          if (v instanceof Prev) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newMonth = (function () {
                      var $20 = Data_Eq.eq(Data_Date_Component.eqMonth)(st.monthSelected)(Data_Date_Component.January.value);
                      if ($20) {
                  ...
                  var newYear = (function () {
                      var $21 = Data_Eq.eq(Data_Date_Component.eqMonth)(newMonth)(Data_Date_Component.December.value);
                      if ($21) {
                          return st.yearSelected - 1 | 0;
                      };
                      return st.yearSelected;
          ...
          throw new Error("Failed pattern match at Main line 183, column 17 - line 183, column 71: " + [ v.constructor.name ]);
      };
